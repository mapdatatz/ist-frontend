...
export default function Members() {
  ...
  const params = `name=${filters?.name}&id=${filters?.id}`;
  ...
  const {
    ...
    queryKey: ["corporates", pagination.page, pagination.limit, params],
    queryFn: () =>
  ...
  useEffect(() => {
    setPagination({ ...pagination, total: corporates?.total });
  }, [corporates, isFetched]);
